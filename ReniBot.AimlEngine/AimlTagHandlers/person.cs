...
namespace ReniBot.AimlEngine.AIMLTagHandlers
{
    ...
    /// </summary>
    public class person : ReniBot.AimlEngine.Utils.AIMLTagHandler
    {
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        public person(ReniBot.AimlEngine.Bot bot,
        ...
        protected override string ProcessChange()
        {
            if (this.templateNode.Name.ToLower() == "person")
            {
                if (this.templateNode.InnerText.Length > 0)
                {
                    ...
                    return ReniBot.AimlEngine.Normalize.ApplySubstitutions.Substitute(this.bot, this.bot.PersonSubstitutions, this.templateNode.InnerText);
                }
                else
                {
